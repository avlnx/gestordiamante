	...
	public function run()
	{
		...
		*/
		...
		foreach ($essencias_fem as $number => $description) {
			...
			DB::table('products')->insert(array(
				...
				'name'			=>	'Perfume UP! '.$number,
				'slug'			=>	'perfume-up-'.Str::slug($number),
				'description'	=>	'Perfume UP! '.$description,
				'price'			=>	$perfume_price,
				'margin'		=>	$margem_padrao,
				'box'			=>	20,
				'created_at'	=> 	date('Y-m-d H:m:s'),
			...
			DB::table('products')->insert(array(
				...
				'name'			=>	'Flaconete UP! '.$number,
				'slug'			=>	'flaconete-up-'.Str::slug($number),
				'description'	=>	'Flaconete UP! '.$description,
				'price'			=>	3,
				'margin'		=>	$margem_padrao,
				'box'			=>	500,
				'created_at'	=> 	date('Y-m-d H:m:s'),
		...
		foreach ($essencias_cremes as $number => $description) {
			DB::table('products')->insert(array(
				...
				'name'			=>	'Creme Hidratante UP! '.$number,
				'slug'			=>	'creme-hidratante-up-'.$number,
				'description'	=>	'Creme Hidratante UP! '.$description,
				'price'			=>	16,
				'margin'		=>	$margem_padrao,
				'box'			=>	12,
				'created_at'	=> 	date('Y-m-d H:m:s'),
		...
		*/
		...
		DB::table('products')->insert(array(
			'tenant_id'		=>	$tenant_id,
			'category_id'	=>	$cats_ids['Acessórios para Kits UP!'],
			'name'			=>	'Sacola Plástica (1 Unidade)',
			'slug'			=>	'sacola-plastica-1-unidade',
			'description'	=>	'Sacola Plástica (1 Unidade)',
			'price'			=>	0.25,
			'margin'		=>	0,
			'box'			=>	NULL,
			'created_at'	=> 	date('Y-m-d H:m:s'),
